...
class SearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets per_page
     *
     * @param int|null $per_page The number of search items to return in one request
     *
     * @return self
     */
    public function setPerPage($per_page)
    {
        ...
        if (($per_page > 100)) {
            throw new \InvalidArgumentException('invalid value for $per_page when calling SearchRequest., must be smaller than or equal to 100.');
        }
        if (($per_page < 1)) {
            throw new \InvalidArgumentException('invalid value for $per_page when calling SearchRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets page
     *
     * @param int|null $page The page of search items to return
     *
     * @return self
     */
    public function setPage($page)
    {
        ...
        if (($page < 1)) {
            throw new \InvalidArgumentException('invalid value for $page when calling SearchRequest., must be bigger than or equal to 1.');
        }
