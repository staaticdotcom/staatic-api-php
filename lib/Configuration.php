...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.staatic.com';
     ...
     * @var string
     */
    protected $userAgent = 'staatic-api-php/1.0.0';
    ...
    {
        $report  = 'PHP SDK (Staatic\Api) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 0.3.1' . PHP_EOL;
