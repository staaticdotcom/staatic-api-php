...
class FormsApi
{
     ...
     * @param  string $include Comma-separated list of additional properties to include in the result (optional)
     * @param  string $query Search query to filter the result (optional)
     ...
     */
    public function getForms($page = null, $per_page = null, $sort = null, $direction = null, $site_id = null, $name = null, $include = null, $query = null, string $contentType = self::contentTypes['getForms'][0])
    {
        list($response) = $this->getFormsWithHttpInfo($page, $per_page, $sort, $direction, $site_id, $name, $include, $query, $contentType);
        return $response;
    }
     ...
     */
    public function getFormsWithHttpInfo($page = null, $per_page = null, $sort = null, $direction = null, $site_id = null, $name = null, $include = null, $query = null, string $contentType = self::contentTypes['getForms'][0])
    {
        $request = $this->getFormsRequest($page, $per_page, $sort, $direction, $site_id, $name, $include, $query, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFormsAsync($page = null, $per_page = null, $sort = null, $direction = null, $site_id = null, $name = null, $include = null, $query = null, string $contentType = self::contentTypes['getForms'][0])
    {
        return $this->getFormsAsyncWithHttpInfo($page, $per_page, $sort, $direction, $site_id, $name, $include, $query, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFormsAsyncWithHttpInfo($page = null, $per_page = null, $sort = null, $direction = null, $site_id = null, $name = null, $include = null, $query = null, string $contentType = self::contentTypes['getForms'][0])
    {
        $returnType = '\Staatic\Api\Model\FormCollection';
        $request = $this->getFormsRequest($page, $per_page, $sort, $direction, $site_id, $name, $include, $query, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getFormsRequest($page = null, $per_page = null, $sort = null, $direction = null, $site_id = null, $name = null, $include = null, $query = null, string $contentType = self::contentTypes['getForms'][0])
    {
